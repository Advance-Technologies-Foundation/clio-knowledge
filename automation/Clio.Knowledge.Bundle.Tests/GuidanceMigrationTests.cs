...
public sealed class GuidanceMigrationTests
{
    ...
    public void BundleSource_ShouldDeclareCanonicalMultiSourceIdentity()
    {
        ...
        try
        {
            ...
            root.GetProperty("sequence").GetUInt64().Should().Be(10,
                because: "recovering the descriptions and article text a per-file audit found missing changed published content, so it is a new immutable knowledge generation");
