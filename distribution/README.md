...
and packages it at `content/knowledge-bundle.zip` under the transport version the package project
declares, which must equal the manifest's `libraryVersion`. Git does not use
