...
- An INACTIVE culture is stored, but users cannot select it until it is activated in the Languages section. Translating first and activating afterwards is a valid order.
