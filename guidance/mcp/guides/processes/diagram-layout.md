...
CrtProcessBuilder 1.6.5.7 a caption the designer recorded a position for is released with the rest and
...
From CrtProcessBuilder 1.6.5.7 the server REFUSES an in-place edit that would re-draw the diagram
