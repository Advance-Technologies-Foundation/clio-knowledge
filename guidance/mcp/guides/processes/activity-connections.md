...
This article is the authoritative owner of the "Connected to" links of the Activity a task creates, and the R1-R20 connection rules.
...
== Connection rules R1–R20 (validate-process-graph enforces the structural subset: R1–R3, R7–R15,
   R17–R20; R4–R6 and R16 are semantic or not yet enforced — verify those yourself.
