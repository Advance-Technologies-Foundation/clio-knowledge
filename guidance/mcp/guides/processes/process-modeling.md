...
- Approval: `approval` (ApprovalUserTask) is BUILDABLE — a configured approval STEP, not a FLOW: branching
  on the verdict needs a gateway. `process-approval` owns the contract.
